                ...
                <div class="s-content__author">
                    ...
                    <div class="s-content__author-about">
                        ...
                        <ul class="s-content__author-social">
                            ...
                            <?php 
                                $philosophy_fb = get_field("facebook","user_".get_the_author_meta("ID")); 
                                $philosophy_tw = get_field("twitter","user_".get_the_author_meta("ID"));
                                $philosophy_in = get_field("instagram","user_".get_the_author_meta("ID"));
                            ...
                            <?php if($philosophy_in): ?>
                            <li><a href="<?php echo esc_url($philosophy_in) ?>">Instagram</a></li>
                            <?php endif; ?>
                ...
                <div class="s-content__pagenav">
                    <div class="s-content__nav">
                        ...
                        <div class="s-content__next">
                            ...
                            ?>
                            <a href="<?php the_permalink($philosophy_next_post) ?>" rel="prev">
